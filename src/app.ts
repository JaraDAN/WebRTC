...
import {
    ...
    CreateCallRequest, SpeakSentence
...
app.use(json());
app.use(cors())
const accountId: string | any = process.env.BW_ACCOUNT_ID;
const username: string | any = process.env.BW_USERNAME;
const password: string | any = process.env.BW_PASSWORD;
const voiceApplicationPhoneNumber: string | any = process.env.BW_NUMBER;
const voiceApplicationId: string | any = process.env.BW_VOICE_APPLICATION_ID;
//const baseCallbackUrl : string | any = process.env.BASE_CALLBACK_URL;
const outboundPhoneNumber: string | any = process.env.USER_NUMBER;
    ...
    try {
        let response = await axios.post(
            `https://voice.bandwidth.com/api/v2/accounts/${accountId}/calls`,
            {
                ...
                to: phoneNumber,
                answerUrl: `https://xd-back-production.up.railway.app/callAnswered`,
                disconnectUrl: `https://xd-back-production.up.railway.app/callStatus`,
